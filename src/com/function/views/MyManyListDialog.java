 ...
 *
 */
public class MyManyListDialog{

	private List<Map<String, String>> list;
	public Dialog alertDialog;
	public Activity context;
	private int strid;
	public AlertListCallback3 alertCallback;
	
	public MyManyListDialog(Activity mActivity, AlertListCallback3 callback, 
			List<Map<String, String>> list, int stringid){
	...
	public interface AlertListCallback3{
		public void clickitem(int i);
	}
	
	public void showMyListDialog() {
		// TODO Auto-generated constructor stub
		View view = LayoutInflater.from(context).inflate(R.layout.faillist_dialogview, null);
